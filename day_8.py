myRoute = ''
...
cleanNodes = []
for i, a in enumerate(nodes.splitlines()):
    node = a.replace(' ','').split('=')
    LR = node[1].replace('(','').replace(')','').split(',')
    node = [node[0], LR]
    cleanNodes += [node]

#print(cleanNodes)

myRoute = myRoute.replace('L','0').replace('R','1')


##part 1 

# #print(cleanNodes[0])
# nextNode = [x for x in cleanNodes if x[0] == 'AAA'][0]
# #print(nextNode)
# soFar = []
# lengthOfRoute = 0
...
#         if len([x for x in soFar if x == [nextNode[0],int(a),i]]) > 0 or nextNode[0] == 'ZZZ':
#             break
...
# Node 3 repeats every 79 route iterations   ## 78 157 
# Node 4 repeats every 53 route iterations   ## 52 105
# Node 5 repeats every 59 route iterations   ## 58 117
# Node 6 repeats every 66 route iterations   ## 66 133
